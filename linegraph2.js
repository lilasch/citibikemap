...
function lineGraph(data, selectedStationCode) {
  ...
  const x = d3.scaleTime()
    .domain([new Date("2020-03-01"), new Date("2020-03-31")]) // Adjust date range to cover the entire month of September
    .range([0, widths]);
...
window.onload = function () {
  createLineGraph("116", "2020", "03"); // Initial default station ID and year
};
